...
initialvalue : 0
initialCellsValue : DrivenDiffusion.val
...
rule : {if ( 2 - trunc(uniform(0,1)+0.9)=1, randInt(1)+11, randInt(1)+13 )}
                   100 {( (0,0)=11 and (0,1)>0 or (0,0)=12 and (1,0)>0 or (0,0)=13 and (0,-1)>0
                            or (0,0)=14 and (-1,0)>0 )}
rule : {if ( 1 + trunc(uniform(0,1)+0.9)=1, randInt(1)+21 , randInt(1)+23 )}
                   100 { ( (0,0)=21 and (0,1)>0 or (0,0)=22 and (1,0)>0 or (0,0)=23 and (0,-1)>0
                            or (0,0)=24 and (-1,0)>0 )}
...
rule : {#macro(RandA)} 100  { (0,0)=11 and (0,1)=0 and ( (1,1)=14 or (1,1)=24  or (0,2)=13 or (0,2)=23 or (-1,1)=12 or (-1,1)=22) 
                              or (0,0)=12 and (1,0)=0 and ((2,0)=14 or (2,0)=24  or (1,1)=13 or (1,1)=23 or (1,-1)=11 or (1,-1)=21)      
                              or (0,0)=13 and (0,-1)=0 and ((0,-2)=11 or (0,-2)=21 or (1,-1)=14 or (1,-1)=24 or (-1,-1)=12 or (-1,-1)=22)
                              or (0,0)=14 and (-1,0)=0 and ((-1,-1)=11 or (-1,-1)=21  or (-1,1)=13 or (-1,1)=23 or (-2,0)=12 or (-2,0)=22)
                              }

rule : {#macro(RandB)} 100  { (0,0)=21 and (0,1)=0 and ( (1,1)=14 or (1,1)=24  or (0,2)=13 or (0,2)=23 or (-1,1)=12 or (-1,1)=22) 
                              or (0,0)=22 and (1,0)=0 and ((2,0)=14 or (2,0)=24  or (1,1)=13 or (1,1)=23 or (1,-1)=11 or (1,-1)=21)      
                              or (0,0)=23 and (0,-1)=0 and ((0,-2)=11 or (0,-2)=21 or (1,-1)=14 or (1,-1)=24 or (-1,-1)=12 or (-1,-1)=22)
                              or (0,0)=24 and (-1,0)=0 and ((-1,-1)=11 or (-1,-1)=21  or (-1,1)=13 or (-1,1)=23 or (-2,0)=12 or (-2,0)=22)
                              }
